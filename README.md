...
allowing to combine data from multiple sources: web maps, remote or local spatial database(s), etc.

Open architecture is designed to split data source schema, processsing logic and rendering:
- database table: data schema
- model: business logic implementation and 2D/3D models
