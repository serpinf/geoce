...
struct wmsLayer;
class gceDataConnectionWMS final : public gceDataConnection
{
public:
    explicit gceDataConnectionWMS(const std::string &connStr);
    ~gceDataConnectionWMS();
...
private:
    ...
    gce::table_data<wmsLayer, std::string> m_tables;
